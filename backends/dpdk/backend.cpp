...
//	new PrepSplitHSIndexExpression(refMap, typeMap, &invokedInKey),
//	new SplitHSIndexExpression(typeMap,refMap),
//        new P4::ClearTypeMap(typeMap),
...
//	new SimplifyAndUnrollArrayIndex(refMap, typeMap, &structure),
